...
(function() {
    ...
    function t() {
        ...
        $.each(e, (e, t) => {
            ...
            switch (d) {
                case "com":
                    i.append(`<element-datepicker-date < id="${o} />`)
            }
            a(), new Vue({
                el: `#${o}`
            })
    ...
    function a() {
        Vue.component("element-datepicker-date", {
            ...
            template: '<el-date-picker v-model="defaultValue" type="date" align="left" editable="false" placeholder="选择日期" :picker-options="pickerOptions" :disabled="false">'
        })
    }
    function n(e, t) {
